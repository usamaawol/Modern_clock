...
export const MathChallenge = ({ open, onSolve, onSnooze }: MathChallengeProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={() => {}}>
      <DialogContent className="glass-card border-border/50 max-w-sm [&>button]:hidden">
        ...
        <div className="py-6 space-y-6">
          <div className="text-center">
            <div className="time-display text-5xl font-bold gradient-text">
              {challenge.problem} = ?
            </div>
          </div>
          ...
          <Input
            ...
            className={`text-center text-2xl h-14 bg-secondary/50 transition-all ${
