        ...
        <div className="space-y-6 py-4">
          ...
          <div className="flex justify-center">
            <Input
              ...
              className="time-display text-5xl font-bold text-center h-auto py-4 bg-transparent border-none focus-visible:ring-0 [&::-webkit-calendar-picker-indicator]:hidden"
            />
          </div>
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="text-sm text-muted-foreground">{snoozeMinutes} min</span>
            </div>
            <Slider
              value={[snoozeMinutes]}
              onValueChange={(v) => setSnoozeMinutes(v[0])}
              min={1}
              max={30}
              step={1}
              className="w-full"
